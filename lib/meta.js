...
var _attachApply = function(obj, method, name) {
    if(method === arguments.callee){
      return;
    }
    obj[name] = function() {
      var args = slice.call(arguments, 0);
      args.unshift(name, method);
      return _apply.apply(obj, args)
    };
    obj[name]._name = name;
  }
  
var _apply = function (name, rule){
  var index = this.index;
  var input = this.input[index], record;
